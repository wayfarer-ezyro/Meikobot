...
from skylee import HEROKU_API_KEY, HEROKU_APP_NAME, OWNER_ID, client
...
OFFICIAL_UPSTREAM_REPO = "https://github.com/StarkGang/meikohero"
BOT_IS_UP_TO_DATE = "`The clientbot is up-to-date.\nThank you for Using this Service.`"
...
async def updater(event):
    ...
    if not changelog:
        message = await event.reply("`Updation in Progress......`")
